...
class AlarmActivity : AppCompatActivity() {
    val PROX_ALERT_INTENT = "com.example.mitchellpatton.mapalarm.AlarmActivity"
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        createNotificationChannel(
                "com.example.mitchellpatton.mapalarm.ProximityAlert",
                "NotifyDemo News",
    ...
    fun sendNotification() {
        ...
        val channelID = "com.example.mitchellpatton.mapalarm"
